...
const sexo_1 = __importDefault(require("../models/sexo"));
const metodos_pago_1 = __importDefault(require("../models/metodos-pago"));
const getSexos = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const sexos = yield sexo_1.default.findAll();
...
const getMetodosDePago = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const metodos = yield metodos_pago_1.default.findAll();
